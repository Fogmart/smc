...
<section id="pre_table">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="btn_add">
                    <button onclick="document.location='<?=Url::to(['user/create'])?>'">Добавить мастера</button>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <!-- Сделать AJAX поиск по таблице -->
                    <input type="text" name="city" placeholder="Поиск мастера">
               </div>
            </div>
...
<section id="table">
  ...
  <?foreach ($user_lst as $i=>$user) {?>
      ...
      <tr>
          ...
          <td class="prof" data-label="Профессия"></td>
