...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        if ($this->new_password) $this->setPassword($this->new_password);
        if (!$this->auth_key) $this->generateAuthKey();
        if (!$this->verification_token) $this->generateEmailVerificationToken();
        if (!$this->username) $this->username = $this->email; //костыль чтобы на проде не применять миграцию. потом убрать
